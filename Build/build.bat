...
set project= "C:\Home\Cowrie\selectedhot.local\DesktopModules\HotelDetails"
set rootPath="C:\Home\Cowrie\selectedhot.local\Bin"
set package= "C:\Temp\HotelDetails"
...
cd %package%
"C:\Program Files\7-Zip\7z" a -tzip HotelDetails.zip *.*
